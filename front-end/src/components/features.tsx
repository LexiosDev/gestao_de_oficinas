        ...
        <div className="mx-auto w-full max-w-5xl px-6">
          ...
          <div className="mt-16 grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
            ...
            <Card className="overflow-hidden p-6 duration-100 hover:brightness-97">
              ...
              <BoxReveal>
                <p className="text-muted-foreground mt-3 text-balance">
                  Registre veículos com marca, modelo, ano, placa e mais.
                  Vincule a um cliente, edite dados e pesquise por placa ou
                  modelo com rapidez.
                </p>
              </BoxReveal>
            </Card>
            ...
            <Card className="group overflow-hidden px-6 pt-6 duration-100 hover:brightness-97">
              ...
              <BoxReveal>
                <p className="text-muted-foreground mt-3 text-balance">
                  ...
                  WhatsApp, SMS ou e-mail sobre status da OS, previsão de
                  entrega e finalização do serviço.
                </p>
              </BoxReveal>
